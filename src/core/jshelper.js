...
function setPrototypeOf(obj, newPrototype) {
    if (Object.setPrototypeOf != null) {
        return Object.setPrototypeOf(obj, newPrototype);
    }
    else {
...
exports.forEachProperty = _.forOwn;
// export function forEachProperty<T>(
// 	/** enumerate hasOwnProperties of this   */
// 	object
// 	, func: (
...
function applyOrNoop(targetFcn, thisObj, argArray, ...argsToPrepend) {
    if (targetFcn == null) {
        return;
    }
    //in case this is IArguments or something of the sort, make a new array
...
exports.applyOrNoop = applyOrNoop;
/** make a copy of a function (doesn"t copy properties) */
function clone(fn, targetThis = {}) {
...
deepCloneDepth = 0) {
    if (source) {
        exports.forEachProperty(source, function (value, prop) {
