...
//var log = new diagnostics.logging.Logger({name:"collections",level:
/* tslint:disable:no-bitwise */
///** simple key/value pairs read/writeable */
//export class KeyValuePair<TKey, TValue> {
//	constructor(public key: TKey, public value: TValue) {
//	}
//	public toString(): string {
//		return stringHelper.format("\"{0}\":\"{1}\"", this.key.toString(), this.value.toString());
//	}
//}
