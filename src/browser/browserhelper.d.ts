...
export declare function onLoad(domElement: any, callback: any): void;
/** get the first attribute and return it"s value from a dom element
example:
var amdMain = getFirstAttribute("script","data-amd-main");
*/
export declare function getDomAttribute(elementType: string, attribute: string, searchTopDown?: boolean): string;
...
attribute?: string, attributeValue?: string, searchTopDown?: boolean): HTMLElement;
/** obatin all cookies */
export declare var getCookies: () => {
    [key: string]: string;
};
export declare function getCookie(key: string, valueIfNullOrEmpty?: string): string;
export declare var getQuerystringVariables: () => {};
export declare function getQuerystringVariable(key: string, valueIfNullOrEmpty?: string): string;
