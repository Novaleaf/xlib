...
export declare type InterceptorId = number;
...
export interface ResponseInterceptor {
    ...
    use<T>(fulfilledFn: (config: AxiosXHR<T>) => AxiosXHR<T>, rejectedFn: (error: any) => any): InterceptorId;
    eject(interceptorId: InterceptorId): void;
}
/**
 * <T> - expected response type,
...
//# sourceMappingURL=axios-d.d.ts.map