...
const convertSourceMap = require("convert-source-map"); //https://www.npmjs.com/package/convert-source-map
...
function __entryPoint(grunt) {
                ...
                watch_target_ts: {
                    options: {
                        ...
                        postBundleCB: (err, src, next) => {
                            ...
                            {
                                var files = grunt.config("browserify.watch_target_ts.files");
    ...
    function loadBabel() {
        ...
        grunt.event.on("watch", (action, filepath, watchTaskName) => {
    ...
    function loadVNextCustomTasks() {
        function loadCustomWatch() {
            _.merge(config, {
                ...
                watch: {
                    ...
                    browserify: {
                        files: ["www_**/*.page.ts", "!www_**/node_modules/**"],
        ...
        function loadCustomEvents() {
            ...
            var onChange = _.debounce(function (action, filepath, watchTaskName) {
