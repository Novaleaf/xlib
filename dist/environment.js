(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", "./node/nodehelper", "./browser/browserhelper", "./exception"], factory);
    }
    ...
    function getEnvironmentVariable(key, valueIfNullOrEmpty) {
        ...
        switch (exports.platformType) {
            ...
            case PlatformType.PhantomJs:
                ...
                break;
            default:
                throw new ex.CorelibException("unsupported plaform type: " + exports.platformType.toString());
        }
