 ...
 * @param num
 */
export function format(value, /** default=5 */ significantDigits, seperatorChar) {
...
export function randomFloat(min_inc, max_exc) {
...
export function randomInt(min_inc, max_exc) {
    if (min_inc === void 0) { min_inc = 0; }
    if (max_exc === void 0) { max_exc = INT32_MAX; }
    //implementation from https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/random
    return Math.floor(Math.random() * (max_exc - min_inc)) + min_inc;
}
export function randomBool(/** the probability that true will be returned.  default 0.5 (50%) */ trueChance) {
 ...
 * @param radix
 */
export function randomIntDigits(digits, radix) {
 ...
 * @param countDecimals
 */
export function countDigits(value, /** default false, count only the whole digits */ countDecimals) {
 ...
 */
export function clamp(value, min_inc, max_inc, clampType) {
...
export var Interpolater = (function () {
 ...
 * @param num
 */
export function toStringDigitGroupings(num, 
    /** default comma */
    seperatorChar, 
...
export function parseInt(toParse, /** invalid strings are returned as this (default=NaN) */ invalidResult, radix) {
...
export function parseFloat(toParse, /** invalid strings are returned as this (default=NaN) */ invalidResult, /** the default parseFloat implementation allows for trailing text.  specifying isStrict=TRUE makes only numbers + "Infinity" allowed to be parsed.   */ isStrict) {
    if (invalidResult === void 0) { invalidResult = NaN; }
...
export function parseBoolean(toParse, invalidResult, throwOnInvalid) {
