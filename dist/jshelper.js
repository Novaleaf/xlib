...
function replaceNodes(targetObject, 
    ...
    function currentNodeProcessor(previousNode, nodeName, hiearchyIndex, hiearchy) {
        if (previousNode == null || exports._.isString(previousNode)) {
        ...
        if (exports._.isArray(thisNode) === true && exports._.isString(thisNode) === false) {
            //walk each element in the array automatically
            exports._.forEach(thisNode, function (element) {
    ...
    exports._.forEach(nodeHiearchyStrings, function (hiearchyString) {
