...
function applyOrNoop(targetFcn, thisObj, argArray) {
    var argsToPrepend = [];
    for (var _i = 3; _i < arguments.length; _i++) {
        argsToPrepend[_i - 3] = arguments[_i];
    }
    if (targetFcn == null) {
        return;
    }
...
function clone(fn, targetThis) {
    if (targetThis === void 0) { targetThis = {}; }
...
function mixin(
    ...
    */
    ...
    if (deepCloneDepth === void 0) { deepCloneDepth = 0; }
    if (source) {
        forEachProperty(source, function (value, prop) {
