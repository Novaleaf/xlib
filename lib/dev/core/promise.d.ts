...
export declare function CreateExposedPromise<T>(callback?: (resolve: (resultOrThenable: T | Promise<T>) => void, reject: (error: any) => void) => void): IExposedPromise<T>;
...
export declare function sequentializePromisedFunction<T>(__this: any, func: (...args: any[]) => Promise<T>): (...args: any[]) => Promise<T[]>;
