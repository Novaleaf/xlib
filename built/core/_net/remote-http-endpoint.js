...
class RemoteHttpEndpoint {
    ...
    _doRequest_send(finalOptions, endpoint, protocol, submitPayload) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return bb.try(() => {
                            ...
                            case "post":
                                {
                                    ...
                                    axiosRequestPromise = axios.default.post(endpoint, submitPayload, finalOptions.requestOptions);
                                }
                                break;
                            case "get":
                                {
                                    axiosRequestPromise = axios.default.get(endpoint, finalOptions.requestOptions);
                                }
                                break;
                            default:
                                {
