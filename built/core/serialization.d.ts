...
export declare namespace jsonX {
    ...
    /**
         ...
         * @param quote  A String representing the quote character to use when serializing strings.
            */
    function stringify(value: any, replacer?: (key: string, value: any) => any | (number | string)[], space?: string | number, quote?: string): string;
    ...
    interface IInspectOptions {
        /** how far down the object structure you wish to inspect.  No values deeper than the depth will be shown.  @default 1 (show current object's values, no children)*/ maxDepth?: any;
        /** maximum array elements you want to display for each array. (half at top, half at bottom)  @default 10 */ maxArrayElements?: any;
        /** when we reach maxDepth, the length we summarize the values to.  @default 120 */ summarizeLength?: any;
        aggrigateFunctions?: boolean;
    }
    function inspectStringify(obj: Object, options?: IInspectOptions): void;
    ...
    function inspectParse(obj: Object, options?: IInspectOptions): any;
