...
quantile = [0, 0.25, 0.5, 0.75, 1]) {
    ...
    let toReturn = mathjs.quantileSeq(msArray, quantile, false);
    return toReturn;
}
...
class PerfTimer {
    constructor(options) {
        ...
        this._storage = {};
        this.options = Object.assign({ autoLogLevel: environment.LogLevel.TRACE }, options);
    ...
    */
     ...
     */
    logNowAndClear(callSiteLevelsUp = 0) {
