...
export declare function quantile(intervals: Array<luxon.Interval | luxon.Duration | number | Stopwatch | {
    valueOf(): number;
}>, 
...
export declare class PerfTimer {
    ...
    */
     ...
     */
    logNowAndClear(callSiteLevelsUp?: number): promise.bluebird<{
        logData: {
            [key: string]: {
                runs: number;
                total: string;
